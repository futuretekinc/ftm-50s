...
config.SENSOR_OIDS = [
  {
    model: 'futureDi',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.1281.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.1281.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.1281.2.1.6',
  },
  {
    model: 'futureDo',
    driver: 'futureActuator',
    countOid:   '1.3.6.1.4.1.42251.1.3.1537.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.1537.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.1537.2.1.6',
  },{
    model: 'futureTemp',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.256.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.256.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.256.2.1.6',
  },{
    model: 'futureHumi',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.512.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.512.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.512.2.1.6' 
  },{
    model: 'futureGas',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.1792.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.1792.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.1792.2.1.6' 
  },{
    model: 'futurePower',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.2048.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.2048.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.2048.2.1.6' 
  },/*{
    model: 'futureDust',
    driver: 'futureSensor',
    countOid:   '1.3.6.1.4.1.42251.1.3.2562.1.0',
    IDsOid:     '1.3.6.1.4.1.42251.1.3.2562.2.1.1',
    valuesOid:  '1.3.6.1.4.1.42251.1.3.2562.2.1.6' 
  }*/
];
config.SNMP_OPTIONS = {
