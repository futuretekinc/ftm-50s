...
#define NETSNMP_CONFIGURE_OPTIONS " '--target=armv5-linux' '--host=armv5-linux' '--with-endianness=little' '--prefix=/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/local' '--libdir=/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/lib' 'host_alias=armv5-linux' 'target_alias=armv5-linux'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/local/share/snmp/mibs"
...
#define SNMPLIBPATH "/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/lib/snmp"
#define SNMPSHAREPATH "/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/local/share/snmp"
#define SNMPCONFPATH "/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/local/etc/snmp"
#define SNMPDLMODPATH "/home/xtra/Work/ftm-50s/rootfs/apps/target/usr/lib/snmp/dlmod"
