...
/* Define if compiling with the futuretek/ftm50s module files.  */
#define USING_FUTURETEK_FTM50S_MODULE 1
 
/* Define if compiling with the futuretek/futuretek module files.  */
#define USING_FUTURETEK_FUTURETEK_MODULE 1
