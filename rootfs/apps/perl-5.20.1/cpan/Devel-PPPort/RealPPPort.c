...
XS_EUPXS(XS_Devel__PPPort_grok_oct)
{
	...
	SV *	string = ST(0)
;
#line 336 "RealPPPort.xs"
                char *pv;
                I32 flags;
                STRLEN len;
#line 514 "RealPPPort.c"
	UV	RETVAL;
	dXSTARG;
#line 340 "RealPPPort.xs"
                pv = SvPV(string, len);
                RETVAL = grok_oct(pv, &len, &flags, NULL);
#line 520 "RealPPPort.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Devel__PPPort_Perl_grok_number)
{
	...
	SV *	string = ST(0)
;
#line 349 "RealPPPort.xs"
                const char *pv;
                STRLEN len;
#line 539 "RealPPPort.c"
	UV	RETVAL;
	dXSTARG;
...
XS_EUPXS(XS_Devel__PPPort_G_DISCARD)
{
	...
	I32	RETVAL;
	dXSTARG;
#line 655 "RealPPPort.xs"
                RETVAL = G_DISCARD;
#line 1136 "RealPPPort.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 666 "RealPPPort.xs"
                PUTBACK;
                i = eval_sv(sv, flags);
                SPAGAIN;
                EXTEND(SP, 1);
                mPUSHi(i);
#line 1165 "RealPPPort.c"
	PUTBACK;
	return;
    }
}
...
#line 703 "RealPPPort.xs"
                I32 i;
#line 1244 "RealPPPort.c"
#line 705 "RealPPPort.xs"
                for (i=0; i<items-2; i++)
                  ST(i) = ST(i+2); /* pop first two args */
                PUSHMARK(SP);
                SP += items - 2;
...
XS_EUPXS(XS_Devel__PPPort_hv_fetchs)
{
	...
	SV *	hv = ST(0)
;
#line 1971 "RealPPPort.xs"
                SV **s;
#line 3859 "RealPPPort.c"
