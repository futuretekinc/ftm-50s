...
;
	...
	gdbm_close(db);
#line 104 "GDBM_File.xs"
#line 332 "GDBM_File.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_GDBM_File_DESTROY)
{
    ...
    {
	GDBM_File	db;
#line 110 "GDBM_File.xs"
	int i = store_value;
#line 348 "GDBM_File.c"
...
;
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "GDBM_File")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"db", "GDBM_File")
;
#line 194 "GDBM_File.xs"
	    DBM_setFilter(db->filter[ix], code);
#line 738 "GDBM_File.c"
    }
    XSRETURN(1);
}
